...
<body>
    ...
    <h1 class="text-center bg-dark text-light py-3 mb-4">Datos usuario</h1>
    <div class="table-responsive">
        <table class="table">
            ...
            <tbody>
                <c:forEach var="ele" items="${datos2}">
                    <tr class="active-row">
                        <td>${ele.idUsuario}</td>
                        <td>${ele.username}</td>
                        <td>${ele.nombre}</td>
                        ...
                        <td><a href="/cliente/modificar2/${ele.idUsuario}" class="lin4"><button class="btn btn-primary">Modificar</button></a></td>
                        <td><a href="/cliente/eliminarCliente/${ele.idUsuario}" class="lin4"><button class="btn btn-primary">Borrar</button></a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
