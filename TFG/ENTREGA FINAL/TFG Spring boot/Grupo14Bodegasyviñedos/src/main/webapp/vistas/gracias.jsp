...
<body>
	...
	<div class="container text-center mt-5">
		<h1 class="bg-light text-dark p-3">${mensaje}</h1>
		<h1 class="bg-light text-dark p-3">${mensaje2}
					<img style="max-width: 100px; max-height: 500px;" src="${pageContext.request.contextPath}/bootstrap/img/seur.png">
		</h1>
	</div>
